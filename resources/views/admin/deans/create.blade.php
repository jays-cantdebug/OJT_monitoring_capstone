...
@section('content')
    <div class="max-w-lg">
        <div class="mb-4 flex items-start gap-3">
            ...
            <div>
                <h2 class="font-bold text-navy">Create Dean Account</h2>
                <p class="text-sm text-black/60">The account will be active immediately, scoped to the department you assign. A secure temporary password will be generated for you to share with them.</p>
            </div>
        </div>

        <div class="bg-white rounded-xl shadow-sm ring-1 ring-light-gray p-5">
            <form method="POST" action="{{ route('admin.deans.store') }}" class="space-y-4">
                @csrf
                ...
                <div class="flex items-center gap-3 pt-2">
                    ...
                    <a href="{{ route('admin.deans') }}" class="text-sm font-medium text-black/60 hover:underline">
                        Cancel
                    </a>
                </div>
            </form>
