        ...
        <div class="space-y-4">
            <div class="bg-white rounded-xl shadow-sm ring-1 ring-gray-100 p-5 text-center">
                <div class="relative mx-auto mb-3 h-20 w-20">
                    <div class="flex h-20 w-20 items-center justify-center rounded-full bg-green-100 text-2xl font-bold text-green-700">
                ...
                <span class="mt-2 inline-block rounded-full bg-blue-100 px-3 py-1 text-[11px] font-bold uppercase tracking-wide text-blue-700">Dean</span>
            </div>
                ...
                <ul class="space-y-3 text-sm">
                    <li class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="font-medium text-gray-900">School of Computing</p>
                        </div>
                    </li>
                    <li class="flex items-start gap-3">
