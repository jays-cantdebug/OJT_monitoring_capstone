            ...
            <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
                ...
                @foreach ($navItems as $routeName => $item)
                    <a
                        ...
                        class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition {{ request()->routeIs($routeName) ? 'bg-amber-400 text-[#1a2332] font-semibold' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}"
                    >
            ...
            <div class="px-3 py-4 border-t border-white/10">
                <div class="flex items-center gap-3 px-2 py-2">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="truncate text-[11px] text-gray-500">BS in Computer Science</p>
                    </div>
                </div>
